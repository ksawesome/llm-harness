...
def call_huggingface_api(model_name: str, prompt_text: str, system_prompt: str) -> dict:
    ...
    try:
        ...
        return {
            "model_version": model_name, "latency_ms": latency_ms if 'latency_ms' in locals() else 0,
            "tokens_in": 0, "tokens_out": 0, "cost_usd": 0.0,
            "response_text": "", "error_message": error_message
        }
    except Exception as e:
        return {
            "model_version": model_name, "latency_ms": 0,
            "tokens_in": 0, "tokens_out": 0, "cost_usd": 0.0,
            "response_text": "", "error_message": str(e)
        }
